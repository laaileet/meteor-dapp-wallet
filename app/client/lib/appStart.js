...
var connect = function(){
    ...
    if(web3.isConnected()) {
        ...
        Meteor.setTimeout(function(){
            // if in mist, tell to start weth, otherwise start with RPC
            var wethRPC = (web3.admin) ? 'weth' : 'weth --rpc --rpccorsdomain "'+window.location.protocol + '//' + window.location.host+'"';
